            ...
            <form action="{{route('home')}}" method="GET" class="p-2 gap-4 flex flex-col justify-between">
                <div class="grid grid-cols-5  grid-rows-2 gap-4">
                    ...
                    <div class="w-full self-center flex justify-end">
                        ...
                        <div>
                            <input name="start_price" value="{{request()->start_price}}" class="w-full col-end-6 col-span-2 border border-gray-300 rounded-md pl-10 pr-4 py-2 focus:border-gray-500 focus:outline-none focus:shadow-outline" type="text" placeholder="First Price">
                            @error('start_price')
                        ...
                        <div>
                            <input name="end_price" value="{{request()->end_price}}" class="w-full col-end-6 col-span-2 border border-gray-300 rounded-md pl-10 pr-4 py-2 focus:border-gray-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Last Price">
                            @error('end_price')
                            <span class="text-red-600">
                            <em class="mr-2 fas fa-info-circle"></em>{{ $message }}
                        </span>
                    ...
                    <div class="row-start-2 col-span-2 gap-4 flex flex-row">
                        <h3 class="w-1/2">All Categories</h3>
