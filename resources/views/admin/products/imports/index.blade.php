    ...
    <div class=" flex items-center justify-between pb-2">
        ...
        <div class="flex gap-4">
            ...
            @can('import', \App\Models\Product::class)
                <a href="{{ \App\Models\Import::formRoute() }}"  class="ml-4 mt-4 w-28 flex self-center gap-2 font-semibold rounded-2xl px-4 py-1 shadow-md bg-gray-300 hover:bg-gray-400 ">
