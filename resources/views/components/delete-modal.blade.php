<modal name-modal="delete" inline-template v-cloak>
    <div v-if="showModal">
                    ...
                    <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
                        ...
                        <form :action="data.route" method="POST">
                            ...
                            <div class="text-center p-5 flex-auto justify-center">
                                ...
                                <h2 class="text-xl font-bold py-4 ">{{trans('dashboard.sure')}}</h2>
                                <p class="text-sm text-gray-500 px-8">{{ $description ?? trans('dashboard.sure_delete_description')}}</p>
                            </div>
                            <!--footer-->
                            <div class="p-3  mt-2 text-center space-x-4 md:block">
                                ...
                                <button type="submit" class="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">{{trans('dashboard.confirm')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
