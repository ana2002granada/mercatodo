            ...
            <div class="md:flex md:items-center bg-white rounded-xl py-4 ">
                ...
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    ...
                    <div class="flex items-center mt-6">
                        <button @click="$root.$emit('add-product', {{ json_encode($product, true) }})" class="bg-primary-500 rounded-2xl text-black font-semibold shadow-md px-4 py-1 flex self-center gap-2 hover:bg-primary-400">
